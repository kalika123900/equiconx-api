...
class AudioFile
{
	...
	{		
		$width=is_int($this->visual_width)?$this->visual_width:1024;
		$height=is_int($this->visual_height)?$this->visual_height:728;
		...
		if ($this->wave_filename<>"" &&  ($this->wave_channels>=1 && $this->wave_channels<=2))
		{
			...
			echo 'Audio File Object not initialized';
	...
	function getId3v2 (&$fp)
	{
		...
		// extended header
		if (property_exists($this->id3v2,'extended') && $this->id3v2->extended==1)
		{
