...
Route::get('oauth/insta/callback', 'UserController@insta_callback');
Route::get('oauth/twitter/request-token', 'UserController@twitter_request_token');
Route::get('oauth/twitter/callback' ,'UserController@twitter_callback');
Route::post('set-country', 'UserController@set_country');
Route::post('get-updated-data', 'UserController@get_updated_data');
Route::post('extra-meta', 'UserController@extra_meta');
...
Route::get('/get-follow-details', 'UserController@get_follow_details');
Route::get('/get-all-creator-profile', 'UserController@get_all_creator_profile');
Route::post('/follow-profile', 'UserController@follow_profile');
Route::get('/get-profile-analytics', 'UserController@get_profile_analytics');
...
Route::post('/update-social-profile', 'UserController@update_social_profile');
...
Route::get("/message-remove", 'UserController@removeMessage');
Route::get("/resolve-scheduled", 'PostController@resolveScheduled');
Route::post("/subscribe-newsletter",'UserController@subscribe_newsletter');
Route::post("/contact-us","UserController@contactUs");
Route::post("/poll-answer","UserController@pollAnswer");
...
Route::get('/search-posts/{id}', 'PostController@search_posts');
Route::get('/twitter-api','PostController@handle_twitter');
...
Route::post('/message-read','ChatController@message_open');
...
Route::post("/update-plan","PlanController@updatePlans");
Route::post("/get-plan-wise-earning","PlanController@getPlanWiseEarning");
Route::post("/get-plan-wise-monthly-total","PlanController@getPlanWiseMonthlyTotal");
// Payment History
...
Route::get("/get-teams", 'UserController@get_user_team');
Route::post("/delete-team-member", 'UserController@deleteTeamMember');
Route::post("/login-as-team", 'UserController@login_as_team');

Route::post("/analytics", 'UserController@analytics');
Route::get("/get-analytics", 'UserController@getAnalytics');
Route::get("/country-wise-tax", 'UserController@get_country_wise_tax');
Route::get("/welcome-email", 'UserController@welcome_email');
Route::post("/master-reports", 'PostController@reportDownload');
Route::post("/report-generate", 'PostController@masterReportPdf');
Route::get("/generate-poll-sheet", 'PostController@pollOptionCsvGenerator');
Route::get("/faq", 'ContactController@faq');
Route::get('/faq/{slug}','ContactController@getFaq');